(function(){
	...
	function ModalImageController($scope, $modalInstance, $log,ImageService,ParameterService){
		...
		$scope.init = function(){
            ...
            $scope.pagination.totalPerPage = 10;
        ...
        $scope.ok = function () {
            $modalInstance.close($scope.selected.item);//send image selected
        };
